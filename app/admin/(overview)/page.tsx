        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            <div className="grid gap-2">
              <a
                href="/admin/users"
                className="flex items-center p-3 text-sm bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors"
              >
              ...
              <a
                ...
                className="flex items-center p-3 text-sm bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors"
              >
                <UserCheck className="h-4 w-4 mr-3 text-gray-600" />
              ...
              <a
                ...
                className="flex items-center p-3 text-sm bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors"
              >
                <Activity className="h-4 w-4 mr-3 text-gray-600" />
                System Settings
              </a>
            </div>
          </CardContent>
